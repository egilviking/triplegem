	...
	switch($action) {
	  case 'install':
		try {
		  ...
		  $this->db->ExecuteQuery(self::SQL('insert content'), array('mypage', 'page', 'My Page', "This is my page.\n\n This is page can be visit by clicking a link", 'plain', $this->user['id']));
