<?php
/**
 * Main class for TripleGem, holds everything.
 *
 * @package CTripleGem
 */
class CTripleGem implements ISingleton {
    ...
    */
    public function ThemeEngineRender() {
        ...
        $themePath  = TRIPLEGEM_INSTALL_PATH . '/' . $this->config['theme']['path'];
        ...
        if(isset($this->config['theme']['parent'])) {
          $parentPath = TRIPLEGEM_INSTALL_PATH . '/' . $this->config['theme']['parent'];
          $parentUrl  = $this->request->base_url . $this->config['theme']['parent'];
        }
       
        // Add stylesheet name to the $tg->data array
        $this->data['stylesheet'] = $this->config['theme']['stylesheet'];
       
        // Make the theme urls available as part of $tg
		...
		// First the default TripleGem themes/functions.php
	...
	*/
	...
	/**
	* Draw HTML for a menu defined in $tg->config['menus'].
	*
