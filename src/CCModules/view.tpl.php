...
<tbody>
  <tr><td>Part of TripleGem Core modules</td><td><?=$module['isTripleGemCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of TripleGem CMF modules</td><td><?=$module['isTripleGemCMF']?'Yes':'No'?></td></tr>
